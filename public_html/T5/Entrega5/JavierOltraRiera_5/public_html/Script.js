 ...
 */
function validar() {
    //Laura: aquí && y en cada función de validación informas de cuál es el formato correcto
    //Laura: cuando un campo es incorrecto y lo vacías hay que deshabiltar el botón de envio
    if (validarFecha()) {
        if (validarTelefono()) {
            if (validarClave()) {
                return true;
